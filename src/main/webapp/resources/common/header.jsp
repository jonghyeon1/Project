...
/* .every{
    ...
    text-align: center;
       ...
       <header>
        <div class="header_left"><a href=#><img src="../headerimg/GUSINSA.png" alt="" id="header_right_img" style="width: 120px; height: 50px;"></a></div>
        ...
        <ul id="header_gita">
            ...
            <li><a href=#><img src="../headerimg/장바구니.png" style="height: 47px;" alt="장바구니" class="header_img"></a></li>
            <li><a href=""><img src="../headerimg/로그인.png" style="height: 47px;" alt="로그인" class="header_img"></li></a>
        </ul>
        </div>
